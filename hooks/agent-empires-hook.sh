#!/bin/bash
# Agent Empires Hook - Captures Claude Code events for RTS battlefield visualization
#
...
# 4. Notifies the WebSocket server on port 4003
...
AE_DATA_DIR="${AGENT_EMPIRES_DATA_DIR:-$HOME/.agent-empires/data}"
EVENTS_FILE="${AGENT_EMPIRES_EVENTS_FILE:-$AE_DATA_DIR/events.jsonl}"
WS_NOTIFY_URL="${AGENT_EMPIRES_WS_NOTIFY:-http://localhost:4003/event}"
ENABLE_WS_NOTIFY="${AGENT_EMPIRES_ENABLE_WS_NOTIFY:-true}"
